...
public class CallUtils {
    ...
    public static void startCallIntent(Context context, User user, String type,
        ...
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.NAME, user.getName());
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.UID,user.getUid());
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.SESSION_ID,sessionId);
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.AVATAR, user.getAvatar());
    ...
    public static void startGroupCallIntent(Context context, Group group, String type,
                                            boolean isOutgoing, @NonNull String sessionId) {
        Intent videoCallIntent = new Intent(context, CometChatCallActivity.class);
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.NAME, group.getName());
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.UID,group.getGuid());
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.SESSION_ID,sessionId);
        videoCallIntent.putExtra(UIKitConstants.IntentStrings.AVATAR, group.getIcon());
        videoCallIntent.setAction(type);
        videoCallIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
