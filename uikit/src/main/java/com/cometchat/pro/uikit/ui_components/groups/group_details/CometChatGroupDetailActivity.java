...
//        rvMemberList.setNestedScrollingEnabled(false);
        ...
        UIKitSettings.joinOrLeaveGroup(false);
        UIKitSettings.allowDeleteGroups(false);
        UIKitSettings.allowAddMembers(false);
        UIKitSettings.allowPromoteDemoteMembers(false);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            onBackPressed();
        } else if (item.getItemId() == R.id.menu_medical){

            Bundle bundle = new Bundle();
            bundle.putString("groupId",guid);
            MedicalDetailsActivity.startActivity(this,bundle);
