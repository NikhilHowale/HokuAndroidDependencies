...
import com.hokuapps.capturevideo.ui.UniversalMediaController;
import com.hokuapps.capturevideo.ui.UniversalVideoView;
...
public class ViewVideoActivity extends AppCompatActivity implements UniversalVideoView.VideoViewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivSend.setOnClickListener(v -> {
            ...
            intent.putExtra(CameraActivity.INTENT_PATH, videoUri.toString());
            intent.putExtra(CameraActivity.INTENT_FILE_CAPTION, caption);
    ...
    /**
     * This method initialize video view
     */
