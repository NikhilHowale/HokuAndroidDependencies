...
public class CameraCapturerCompat implements VideoCapturer {
    ...
    public void changeCaptureFormat(int width, int height, int framerate) {
       // VideoCapturer.super.changeCaptureFormat(width, height, framerate);
    }
    ...
    /**
     *  Check camera is supported or not using camera id
     * @param cameraId camera id
     * @return return true if camera is supported
     */
