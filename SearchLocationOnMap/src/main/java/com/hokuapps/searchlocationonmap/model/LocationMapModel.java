package com.hokuapps.searchlocationonmap.model;
...
public class LocationMapModel implements Parcelable {
    ...
    public static final Creator<LocationMapModel> CREATOR = new Creator<LocationMapModel>() {
        ...
        public LocationMapModel createFromParcel(Parcel source) {
            ...
            locationMapModel.isSearchAndDrop = source.readInt();
            locationMapModel.isAllCountry = source.readInt();
    ...
    public int getIsSearchAndDrop() {
        return isSearchAndDrop;
    }

    public void setIsSearchAndDrop(int isSearchAndDrop) {
        this.isSearchAndDrop = isSearchAndDrop;
    }

    public int getIsAllCountry() {
        return isAllCountry;
    }

    public void setIsAllCountry(int isAllCountry) {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(isSearchAndDrop);
        parcel.writeInt(isAllCountry);
