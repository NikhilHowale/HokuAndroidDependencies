...
public class CameraControlPanel extends RelativeLayout
    ...
    private void init() {
        ...
        zoomlevel = (TextView) findViewById(R.id.zoomlevel);
        ...
        galleryBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (galleryClickListener != null) galleryClickListener.onGalleryClick();
            }
        });
    ...
    public void setZoomlevel(int level) {
        zoomlevel.setText(String.valueOf(level));
    }
    ...
    //    recyclerView.setVisibility(isShown ? VISIBLE : GONE);
        galleryBtn.setVisibility(isShown ? VISIBLE : GONE);
    }
